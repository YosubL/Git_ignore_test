...
public class Assume_unchanged_8 {
	...
	*/
		...
		System.out.println("==== Assume_unchanged_8.java 파일의 내용을 변경 합니다. ===="); 
		System.out.println("==== Assume_unchanged_8.java 파일의 내용을 또 변경 합니다. ===="); 
		System.out.println("==== Assume_unchanged_8.java 파일의 내용을 완료 합니다. ====");
